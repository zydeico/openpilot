...
BODY_VERSION_REQUEST = bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.ECU_MANUFACTURING_DATE)
BODY_VERSION_RESPONSE =  bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER + 0x40]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.ECU_MANUFACTURING_DATE)

BODY_DEFAULT_DIAGNOSTIC_REQUEST = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL,
                                    uds.SESSION_TYPE.DEFAULT])
BODY_DEFAULT_DIAGNOSTIC_RESPONSE = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL + 0x40,
                                    uds.SESSION_TYPE.DEFAULT])

BODY_EXTENDED_DIAGNOSTIC_REQUEST = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL,
                                     uds.SESSION_TYPE.EXTENDED_DIAGNOSTIC])
BODY_EXTENDED_DIAGNOSTIC_RESPONSE = bytes([uds.SERVICE_TYPE.DIAGNOSTIC_SESSION_CONTROL + 0x40,
                                      uds.SESSION_TYPE.EXTENDED_DIAGNOSTIC])
...
REQUESTS = [
  ...
  (
    "body",
    [TESTER_PRESENT_REQUEST, BODY_DEFAULT_DIAGNOSTIC_REQUEST, BODY_EXTENDED_DIAGNOSTIC_REQUEST, BODY_VERSION_REQUEST],
    [TESTER_PRESENT_RESPONSE, BODY_DEFAULT_DIAGNOSTIC_RESPONSE, BODY_EXTENDED_DIAGNOSTIC_RESPONSE, BODY_VERSION_RESPONSE],
    DEFAULT_RX_OFFSET,
  ),
  # Subaru
  (
